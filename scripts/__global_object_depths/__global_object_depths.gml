function __global_object_depths() {
	...
	// insert the generated arrays here
	global.__objectDepths[0] = -99; // obj_game
	global.__objectDepths[1] = 0; // obj_parent_solid
	global.__objectDepths[2] = 0; // obj_parent_entity
	global.__objectDepths[3] = 0; // oBlock
	global.__objectDepths[4] = 0; // oPushBlock
	global.__objectDepths[5] = 0; // oSpring
	global.__objectDepths[6] = 0; // oFadeBlock
	global.__objectDepths[7] = 0; // oSlopeR
	global.__objectDepths[8] = 0; // oSlopeL
	global.__objectDepths[9] = -1; // obj_player
	global.__objectDepths[10] = -10; // oBlood
	global.__objectDepths[11] = -2; // obj_camera
	global.__objectDepths[12] = 0; // obj_particle


	global.__objectNames[0] = "obj_game";
	global.__objectNames[1] = "obj_parent_solid";
	global.__objectNames[2] = "obj_parent_entity";
	global.__objectNames[3] = "oBlock";
	global.__objectNames[4] = "oPushBlock";
	global.__objectNames[5] = "oSpring";
	global.__objectNames[6] = "oFadeBlock";
	...
	global.__objectNames[12] = "obj_particle";
