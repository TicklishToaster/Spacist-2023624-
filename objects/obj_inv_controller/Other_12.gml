...
ex_ui_panel_open(global.inv_backpack, obj_inv_panel_backpack, 
	0, 
	0, layer);

//Show the player equipment
ex_ui_panel_open(global.inv_equipment, obj_inv_panel_equipment, 
	obj_camera.display_width - sprite_get_width(spr_equipment),
	0, layer);
