...
if (state_building) {
	...
	if (!state_selected) {
		...
		//for (var i = 0; i < array_length(current_building_sprite_misc); ++i) {
		//	draw_sprite_ext(current_building_sprite_misc[i], 0, snap_x + snap_dist/2, snap_y, 4, 4, 0, c_white, 0.7);
		//}
	...
	if (state_selected) {
		...
		if (!state_repeating) {
			...
			//for (var i = 0; i < array_length(current_building_sprite_misc); ++i) {
			//	draw_sprite_ext(current_building_sprite_misc[i], 0, snap_x_origin, snap_y_origin, 4, 4, 0, c_white, 0.7);
			//}			
		}
