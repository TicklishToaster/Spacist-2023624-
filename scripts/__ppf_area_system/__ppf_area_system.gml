...
function area_draw_rect(x, y, w, h, x_offset, y_offset, pp_index) {
	...
	var _surf = pp_index._pp_stack_surface[pp_index._pp_surf_index];
...
function area_draw_sprite_mask(sprite_mask, subimg, x, y, pp_index) {
	...
	if surface_exists(_surf) {
		...
		shader_set_uniform_f(__PPF_SU.mask_render_posres, pp_index._pp_render_x, pp_index._pp_render_y, pp_index._pp_render_vw, pp_index._pp_render_vh);
