...
global.__ppf_shader_uniforms = {
	...
	base_main : {
		...
		time_n_intensity : shader_get_uniform(__PPF_SH_BASE, "time_n_intensity"),
		enabledd : shader_get_uniform(__PPF_SH_BASE, "enabled"),
	},
	color_grading : {
		pos_res : shader_get_uniform(__PPF_SH_COLOR_GRADING, "pos_res"),
		time_n_intensity : shader_get_uniform(__PPF_SH_COLOR_GRADING, "time_n_intensity"),
		enabledd : shader_get_uniform(__PPF_SH_COLOR_GRADING, "enabled"),
	},
	base_final : {
		pos_res : shader_get_uniform(__PPF_SH_FINAL, "pos_res"),
		time_n_intensity : shader_get_uniform(__PPF_SH_FINAL, "time_n_intensity"),
		enabledd : shader_get_uniform(__PPF_SH_FINAL, "enabled"),
	},
	...
	sunshafts : {
		...
		time_n_intensity : shader_get_uniform(__PPF_SH_SUNSHAFTS, "time_n_intensity"),
	...
	bloom : {
		...
		time_n_intensity : shader_get_uniform(__PPF_SH_BLOOM, "time_n_intensity"),
	...
	depth_of_field : {
		...
		bokeh_time_n_intensity : shader_get_uniform(__PPF_SH_DOF_BOKEH, "time_n_intensity"),
	...
	motion_blur : {
		...
		time_n_intensity : shader_get_uniform(__PPF_SH_MOTION_BLUR, "time_n_intensity"),
	},
	blur_radial : {
		time_n_intensity : shader_get_uniform(__PPF_SH_RADIAL_BLUR, "time_n_intensity"),
	...
	palette_swap : {
		time_n_intensity : shader_get_uniform(__PPF_SH_PALETTE_SWAP, "time_n_intensity"),
	...
	blur_kawase : {
		time_n_intensity : shader_get_uniform(__PPF_SH_KAWASE_BLUR, "time_n_intensity"),
	...
	blur_gaussian : {
		...
		time_n_intensity : shader_get_uniform(__PPF_SH_GAUSSIAN_BLUR, "time_n_intensity"),
	...
	chromaber : {
		...
		time_n_intensity : shader_get_uniform(__PPF_SH_CHROMABER, "time_n_intensity"),
...
global.__ppf_shader_textures = {
	...
	default_prisma_lut : sprite_get_texture(__spr_ppf_prism_lut_rb, 0),
